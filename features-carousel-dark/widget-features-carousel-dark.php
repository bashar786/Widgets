...
class featuresCarouselDark extends Widget_Base
{
    ...
    wp_register_script( 'features-carousel-dark', get_template_directory_uri() . '/widgets/features-carousel-dark/features-carousel-dark.js', ['elementor-frontend', 'jquery'], '1.0.0', true );
    wp_register_script( 'features-carousel-dark-elementor', get_template_directory_uri() . '/widgets/features-carousel-dark/features-carousel-dark-elementor.js', ['elementor-frontend', 'jquery'], '1.0.0', true );

		wp_register_style('features-carousel-dark-css', get_template_directory_uri() . '/widgets/features-carousel-dark/features-carousel-dark.css', [], '1.1' );
 }

 public function get_script_depends() {
     return [ 'features-carousel-dark', 'features-carousel-dark-elementor'];
 }

 public function get_style_depends() {
  return [ 'features-carousel-dark-css' ];
}


public function get_name() {
	return 'featuresCarouselDark';
}

	public function get_title()
	{
		return esc_html__('Features Carousel Dark', 'cabei');
	}
...
<div class="widget-features-carousel-dark-v1"> 
